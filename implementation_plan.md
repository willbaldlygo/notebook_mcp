...
- **Tool**: `query_notebook(url, question)` - The primary interaction.
...
### 1. Cleanup
- Isolate clean python files: `server.py`, `notebook_session.py`, `auth_setup.py`.
- Delete debug images.

### 2. Documentation
- Create `README.md` (Project overview, Setup, Usage)
- Create `LICENSE` (MIT)
- Create `.gitignore` (Exclude cookies, profiles, venv)

### 3. Dependencies
- Generate `requirements.txt` (`mcp`, `playwright`).
